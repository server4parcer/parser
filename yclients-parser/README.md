...
Система для автоматизированного сбора данных с платформы YCLIENTS. Позволяет парсить информацию о доступных датах бронирования, временных слотах, ценах, исполнителях и номерах мест.
